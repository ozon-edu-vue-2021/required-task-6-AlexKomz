...
import TableView from "@/components/table-view/TableViewFunc";
import TablePaginator from "@/components/table-paginator/TablePaginatorFunc";
import TableLoader from "@/components/table-loader/TableLoaderFunc";
